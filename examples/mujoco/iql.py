...
def create_learner(
        ...
        loaded_params = {'MLP_0':pickle.load(open('/home/dima/UCI/GraphModels/final_proj/jaxrl_m/examples/mujoco/models/params.pkl', 'rb'))['agent']['value']['params']['phi']}
        
        ### WE HAVE ONLY 2 LAYERS PRETRAINED ###
        loaded_params['MLP_0']['layers_2'] = value_params['MLP_0']['layers_2']

        value = TrainState.create(value_def, loaded_params, tx=optax.adam(learning_rate=value_lr))
